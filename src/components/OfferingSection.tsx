export function OfferingSection() {
  return (
    ...
    >
      <div className="mx-auto grid max-w-6xl gap-8 px-4 sm:px-6 lg:grid-cols-2 lg:items-center lg:gap-10 lg:px-8">
        <div className="relative overflow-hidden rounded-2xl border border-[#dadada]">
          <img
            ...
            loading="lazy"
          />
          <div className="absolute inset-0 bg-gradient-to-t from-[#2f4366]/60 via-transparent to-transparent opacity-90" />
          <p className="absolute bottom-4 left-4 right-4 font-display text-sm font-semibold text-[#f9fafb]">
        ...
        <div>
          ...
          <p className="mt-5 text-[14px] leading-relaxed text-[#2f4366]">
            Spindle is an{' '}
