      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-16">
          ...
          <div className="rounded-2xl border border-white/[0.08] bg-gradient-to-b from-white/[0.04] to-transparent p-8 sm:p-10">
            <p className="font-display text-[11px] font-semibold uppercase tracking-[0.35em] text-[#c9a227]">
              value proposition
            </p>
            <p className="font-display mt-4 text-2xl font-semibold leading-snug text-white sm:text-3xl">
              From reactive, manual workflows to autonomous, intelligent
              operations.
            </p>
            <p className="mt-4 text-[15px] leading-relaxed text-zinc-400">
              Spindle uses agentic AI to{' '}
              <strong className="font-semibold text-zinc-200">execute</strong>{' '}
            ...
            <ul className="mt-8 space-y-3 text-[14px] text-zinc-500">
